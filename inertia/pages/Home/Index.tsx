...
const HERO_SHOT = '/images/landing/screenshot-dashboard.png'
const MATERIALS_SHOT = '/images/landing/screenshots-materials.png'
const ROUTINES_SHOT = '/images/landing/screenshot-routine.png'
const SHOWS_SHOT = '/images/landing/screenshot-checklist.png'
...
export default function Index() {
  ...
  return (
    <>
      <Head title="Arcane Ledger — Gérez votre magie" />
      ...
      <div style={{ fontFamily: "'Manrope', sans-serif", color: '#1b1c1c', overflowX: 'hidden' }}>
        ...
        >
          ...
          >
            ...
            >
              Arcane Ledger est l'application pensée pour les magiciens professionnels.
              Inventoriez chaque matériel, construisez vos numéros, planifiez vos shows.
            </p>
            ...
            <div style={{ width: '100%', maxWidth: '900px', marginTop: '64px' }}>
              <ScreenshotFrame
                src={HERO_SHOT}
                alt="Tableau de bord Arcane Ledger"
        ...
        >
          ...
          >
            {[
              { value: '7', label: 'outils dédiés', icon: 'widgets' },
          ...
          >
            ...
            <div>
              ...
              <p style={{ fontSize: '16px', color: '#78716c', lineHeight: 1.75, marginBottom: '28px' }}>
                Ajoutez vos matériels un à un : cordes, cartes, baguettes, foulards...<br />Associez-leur une catégorie, un type et un emplacement de rangement pour ne plus jamais les chercher.
              </p>
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: '72px' }}>
              ...
              <p style={{ fontSize: '16px', color: '#78716c', maxWidth: '440px', margin: '0 auto' }}>
                Arcane Ledger est conçu pour être pris en main en quelques minutes.
              </p>
            </div>
